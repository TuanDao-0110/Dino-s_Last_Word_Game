...
import { setWordToGuess, setGameStatus, setNextRound, setScore, setModal } from "../../../features/GameSlice";

import { Word, Keyboard, Message, Object, LeaderBoard, Controls } from "../../../assets/export_component/resource";
...
const Main = () => {
  ...
  const { wordToGuess, guessedLetters, gameStatus, category, score, hints, round, showModal } = useAppSelector((state) => state.game);
